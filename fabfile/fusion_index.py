...
def deploy():
    ...
    run('docker run --detach --name=fusion-index --volume=/srv/db/fusion-index:/db --volume=/srv/certs:/srv/certs --publish=8443:8443 --workdir=/db fusionapp/fusion-index start --pidfile "" --nodaemon')
